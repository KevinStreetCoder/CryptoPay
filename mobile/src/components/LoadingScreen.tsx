...
// design handoff ships (cpay/project/logos.jsx · Wordmark) so it stays
// pixel-accurate with the rest of the brand system. Regenerate after
// any brand-system change.
const BRAND_WORDMARK = require("../../assets/brand-wordmark.png");
...
export function LoadingScreen({ status }: { status?: string }) {
  ...
  return (
    ...
    >
      ...
      {/* Brand lockup · single PNG. No Text rendering = no font-loading
          race, no Android metric-box clip, no "Cpa" truncation. 160×40
          display size keeps it readable on small phones without
          dominating the splash. */}
      <Image
